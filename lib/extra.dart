...
/// Creates a [State] that generates source that will transform the result of
...
///
/// When used with [Sequence] state, the index corresponds to the result of the
...
///
/// This function is used internally by [Sequence] to prevent duplication of the
/// generated code. All elements of [Sequence], except the last element, if they
...
/// computations until the next [state] computation fails.
///
/// This operation always completes successfully or 'goes' into an infinite
/// loop.
